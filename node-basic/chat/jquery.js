        ...
        fire = function( context, args ) {
            ...
            for ( ; list && firingIndex < firingLength; firingIndex++ ) {
                if ( list[ firingIndex ].apply( context, args ) === false && flags.stopOnFalse ) {
                    memory = true; // To prevent further calls using add
                    break;
                }
            }
            firing = false;
            if ( list ) {
                if ( !flags.once ) {
                    //if has any fire() in the callback(repeatable callback), invoke them
 ...
 */
jQuery.event = {
    //.on() --> jQuery.event.add( this, types, fn, data, selector )
    ...
    trigger: function( event, data, elem, onlyHandlers/**true or undefined**/ ) {
...
jQuery.fn.extend({
    ...
    on: function( types/**event names or types-Object**/, selector, data, fn, /*INTERNAL*/ one ) {
        var origFn, type;
        ...
        return this.each( function() { // |this| ->jQuery.fn.init(), invoke each:function( callback, args ), then invoke jQuery.each( this, callback, args )
